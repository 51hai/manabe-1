# Generated by Django 3.0.3 on 2020-02-18 14:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sever_app_name', to='appinput.App', verbose_name='应用名')),
                ...
                ('op_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='server_op_user', to=settings.AUTH_USER_MODEL, verbose_name='操作用户')),
            ],
            options={
                'db_table': 'server',
            },
