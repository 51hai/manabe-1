$(".buildBtn").click(function(e){
    //将该节点的app_name属性的值替换掉id为modal_app_name标签中间的内容
    //替换内容的功能是.html()方法实现的
    //$(this).attr(..)是仅限点击的那个button上的属性
    //也就是说，点击“编译”，只能获取到该btn上的app_name，deploy_version，jenkins_job
...
$(".checkBtn").click(function(e){
    //点击“检测”，只能获取到该btn上的app_name，deploy_version
...
function openFullScreen (url) {
    //name为"_blank",指定URL加载到一个新的窗口。这是默认
    var name = "_blank";
    console.log(name)
...
$(".btn_gen_pkg").click(function(){
    ...
    var promiseJenkinsB = promiseJenkinsA.then(function(data){
        ...
        //第隔二秒，获取jenkins的编译进度
        intervalKey = setInterval(showStatus, 4000);
    });
